...
export default function Hero({ url, title, description, buttonText, buttonLink, isAbsolute = false }: VideoProps) {
  return (
    <div className={`${isAbsolute ? "" : "relative"} h-screen flex flex-col items-center justify-center`}>
      <VideoComponent
        className={`absolute top-0 left-0 w-full h-full object-cover z-0`} url={url} />
