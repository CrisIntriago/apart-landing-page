...
export default function HeroPrincipal({
  ...
  }, [title]); // La animación se ejecuta cuando el título cambia
      ...
      <div className="relative inset-0 flex flex-col items-center justify-center text-white font-guru z-10">
        ...
        {buttonText && (
          <Link href={buttonLink}>
            <button
              ref={buttonRef}
              className="border-2 border-white rounded-full mt-6 w-auto max-w-xs hover:bg-[#4d4d4d] transition-all duration-300"
            >
