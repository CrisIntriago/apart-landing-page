...
export default function Home() {
  return (
    <>
      ...
      <SectionInformation image="https://apartcdn.s3.sa-east-1.amazonaws.com/banner-apart.mp4" eslogan='“Cada avance tecnológico es una oportunidad para superar límites y reimaginar el futuro.”' autor="Jeff Bezos ~ Fundador de Amazon" descripcion="Aprende inglés en 
      grupos reducidos de máximo 6 estudiantes, con la atención personalizada de profesores altamente experimentados, 
      para maximizar tu aprendizaje y progreso." bgColor="5B473C" inverted= {true}  />
